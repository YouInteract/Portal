            ...
            <div id="body" style="width: 1000px; margin: 0 auto; margin-top: 120px;">
                <div id="side bar" style="width: 150px; float: left;">
                    <ul class="nav nav-pills nav-stacked">
                        ...
                        <br />
                        <li class="active"><a href="addadmin.aspx">
                            <asp:Label ID="Label5" runat="server" CssClass="nav nav-pills nav-stacked" Text="Add Admin"></asp:Label></a></li>
                    </ul>
                </div>
                <div id="content" style="width: 800px; height: 500px; border: 1px solid #d3d6db; float: left; padding-bottom: 50px; background-color: #FFFFFF; border-radius: 5px; margin-left: 10px;">
                    ...
                    <div id="contentbody" style="text-align: left; padding-left: 20px">
                        ...
                        <asp:TextBox ID="newUser" TextMode="SingleLine" class="form-control" placeholder="New user" runat="server" Width="300px" />

                        <asp:RequiredFieldValidator
                            ID="RequiredFieldValidator3"
                            ControlToValidate="newUser"
                            ErrorMessage="Please enter the new administrator username"
                            Display="Dynamic"
                            runat="server" />
                        <asp:CustomValidator ID="checku" runat="server"
                            ControlToValidate="newUser"
                            ErrorMessage="Username must be at least 5 characters long.<br />"
                            OnServerValidate="CheckUser"
                            Display="Dynamic"
                            ClientValidationFunction="CheckUsJ" />
                        ...
                        <script type="text/javascript">
                            function CheckUsJ(source, args) {
                                args.IsValid = args.Values.length >= 5;
                            }
                        ...
                        <label id="writeWrongPW" runat="server"></label >
                        </div>
                    </div>
                </div>
