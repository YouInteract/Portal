    ...
    <form id="form1" runat="server">
        <div id="container" style="width: 100%;">
            ...
            <div id="body" style="width: 1000px; margin: 0 auto; margin-top: 120px;">
                ...
                <div id="content" style="width: 800px; margin: 0 auto; height: 500px; border: 1px solid #d3d6db; float: left; padding: 50px; padding-bottom: 50px; background-color: #FFFFFF; border-radius: 5px; margin-left: 10px;">
                    <h1 style="text-align: center">Applications</h1>
                    <li><h4><a href="configvideoapp.aspx">Video App</a></h4>
